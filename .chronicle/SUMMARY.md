...
- **[17420910]** README.md — `open` (0.95) — README.md must be updated in every PR that adds a command, subcommand, flag, or user-visible behaviour — documentation drift is invisible without explicitly checking it. README update is part of every feature PR's definition of done — check git log --follow -- README.md before opening a PR.
